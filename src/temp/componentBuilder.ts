...
import * as AirlineLogo from 'src/components/KFIA/Flights/Airlines/AirlineLogo';
import * as AirlinesPanel from 'src/components/KFIA/Flights/Airlines/AirlinesPanel';
import * as logos from 'src/components/KFIA/Flights/Airlines/logos';
...
import * as types from 'src/components/KFIA/Flights/Airlines/types';
import * as useAutoMobile from 'src/components/KFIA/Flights/Airlines/useAutoMobile';
import * as destinationsdata from 'src/components/KFIA/Flights/Destinations/destinations.data';
import * as DestinationsMap from 'src/components/KFIA/Flights/Destinations/DestinationsMap';
import * as DestinationsSearch from 'src/components/KFIA/Flights/Destinations/DestinationsSearch';
import * as MapLegend from 'src/components/KFIA/Flights/Destinations/MapLegend';
import * as date from 'src/components/KFIA/Flights/Flights-Panel/date';
import * as FlightsPanel from 'src/components/KFIA/Flights/Flights-Panel/FlightsPanel';
import * as FlightsTable from 'src/components/KFIA/Flights/Flights-Panel/FlightsTable';
import * as TabPills from 'src/components/KFIA/Flights/Flights-Panel/TabPills';
import * as useShouldForceMobile from 'src/components/KFIA/Flights/Flights-Panel/useShouldForceMobile';
...
import * as LoungeCards from 'src/components/KFIA/Lounges/LoungeCards';
...
import * as RideShareTiles from 'src/components/KFIA/Parking-Transport/RideShareTiles';
...
components.set('AirlineLogo', AirlineLogo);
components.set('AirlinesPanel', AirlinesPanel);
components.set('logos', logos);
components.set('MobileAirlineCard', MobileAirlineCard);
components.set('share', share);
components.set('useAutoMobile', useAutoMobile);
components.set('destinations.data', destinationsdata);
components.set('DestinationsMap', DestinationsMap);
components.set('DestinationsSearch', DestinationsSearch);
components.set('MapLegend', MapLegend);
components.set('date', date);
components.set('FlightsPanel', FlightsPanel);
components.set('FlightsTable', FlightsTable);
components.set('TabPills', TabPills);
components.set('useShouldForceMobile', useShouldForceMobile);
...
components.set('LoungeCards', LoungeCards);
...
components.set('RideShareTiles', RideShareTiles);
